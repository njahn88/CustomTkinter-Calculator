...
#frame.columnconfigure((4), column)
...
button1b.grid(row=1, column=0, padx=5, pady=3)
...
button2b.grid(row=1, column=1, padx=5, pady=3)
...
button3b.grid(row=1, column=2, padx=5, pady=3)
...
button4b.grid(row=1, column=3, padx=5, pady=3)
...
button1c.grid(row=2, column=0, padx=5, pady=3)
...
button2c.grid(row=2, column=1, padx=5, pady=3)
...
button3c.grid(row=2, column=2, padx=5, pady=3)
...
button4c.grid(row=2, column=3, padx=5, pady=3)
...
button1d.grid(row=4, column=0, columnspan=2, padx=5, pady=3)
...
button2d.grid(row=4, column=2, padx=5, pady=3)
...
button3d.grid(row=4, column=3, padx=5, pady=3)
